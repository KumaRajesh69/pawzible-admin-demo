    ...
    <div>
      <div className="mx-2 my-9 shadow-2xl bg-green-200  rounded-xl overflow-hidden p-2 ">
        ...
        <div className="flex space-x-5 mx-4">
          <button class="border border-orangePrimery text-gray-500 text-base font-normalnt py-1 w-44 px-5 hover:bg-orangePrimery hover:text-white font-bold  rounded">
            Dentistry
          </button>
          <button class="border  border-orangePrimery text-gray-500 text-base font-normalnt py-1 w-44 px-5 hover:bg-orangePrimery  hover:text-white font-bold  rounded">
            Nutrition
